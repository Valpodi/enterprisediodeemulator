...
class VerifyBitmapTests(unittest.TestCase):
    def test_bitmap_contains_valid_header(self):
        bitmap_sample = b'BM\x03\x00\x00\x00\x00\x00\x00\x00\x00\x10\x12\x00\x00\xa0\x0f\x00\x00\x01\x00\x18\x00\x00\x00\x00\x00\x00\x03\x00\x00'
        self.assertTrue(VerifyBitmap().validate(bitmap_sample))

    def test_bitmap_validate_throws_with_invalid_header(self):
        bitmap_sample = b'BC\x03\x00\x00\x00\x00\x00\x00\x00\x00\x10\x12\x00\x00\xa0\x0f\x00\x00\x01\x00\x18\x00\x00\x00\x00\x00\x00\x03\x00\x00'
